...
export default function Index() {
  ...
  // // Динамическая палитра цветов для контейнера и заголовков секций списка
  ...
  // } : {
  //   containerBg: '#F8FAFC', // Мягкий светлый пастельный фон
  //   headerRowBg: '#F8FAFC',
  //   sectionTitle: '#64748B', // Сдержанный темный сланец
  //   missedSectionTitle: '#EF4444', // Насыщенный красный
  //   completedSectionTitle: '#22C55E', // Насыщенный зеленый
  //   badgeBg: '#E2E8F0',
  //   badgeText: '#334155',
