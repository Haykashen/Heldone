...
const Add = ({ date }: AddProps) => {
  ...
  // Реф для предотвращения множественных кликов
  const isPressingRef = useRef(false);

  const handlePress = () => {
    // Если переход уже выполняется, игнорируем клик
    ...
    // Разблокируем кнопку через короткое время (когда экран гарантированно откроется)
    setTimeout(() => {
